...
VALUES
    ...
    ('MIFARE_KEY_B', 'B0B1B2B3B4B5');

INSERT INTO cards (card_no, balance, blocked, owner_name, key_id)
VALUES
    ('10000001', 500.00, 0, 'Ivan Petrov', 1),
    ('10000002', 50.00, 0, 'Maria Sidorova', 2),
    ('10000003', 0.00, 1, 'Blocked Card', 1);

INSERT INTO terminals (serial_number, address, display_name)
VALUES
    ('T-001', 'Moscow, Lenina 1', 'North Gate'),
    ('T-002', 'Moscow, Mira 15', 'Bus #15');
